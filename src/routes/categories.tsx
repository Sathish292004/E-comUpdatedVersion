  ...
  head: () => ({
    meta: [
      { title: "Shop by category — SK" },
      {
        name: "description",
        content:
          "Browse every SK category — sneakers, apparel, audio, watches, bags and accessories.",
      },
    ...
    <main className="mx-auto max-w-7xl px-4 py-12 sm:py-16">
      <header className="mb-10 max-w-2xl">
        ...
        <p className="mt-3 text-muted-foreground">
          Find what you love by browsing every department. Hand-picked products
          from the world's most-watched brands, delivered beautifully.
        </p>
      </header>
        ...
        {categories.map((c: Category, i: number) => (
          ...
          >
            <Link
              ...
              className={`group relative block overflow-hidden rounded-3xl bg-gradient-to-br ${
                palette[i % palette.length]
              } p-6 shadow-card transition hover:-translate-y-1 hover:shadow-soft`}
              ...
              <div className="mt-10 flex items-end justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Shop the {c.name.toLowerCase()} edit
                  </p>
                </div>
